package ru.anani.lesson15.solid;
...
public class SalaryHtmlReportNotifier {
    ...
    public void generateAndSendHtmlSalaryReport(String departmentId, LocalDate dateFrom, LocalDate dateTo, String recipients) {
        try {
            String html = generateHtmlSalaryReport(departmentId, dateFrom, dateTo);
            sendHtmlSalaryReport(recipients, html);
    ...
    public String generateHtmlSalaryReport(String departmentId, LocalDate dateFrom, LocalDate dateTo) throws SQLException {
    ...
    public void sendHtmlSalaryReport(String recipients, String resultingHtml) throws MessagingException {
